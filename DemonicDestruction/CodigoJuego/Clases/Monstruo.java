    ...
    public Monstruo(TipoMonstruos tipo) {
        switch(tipo) {
            case BESTIA:
                ...
                inicializarEtiqueta("/Users/eric/Desktop/Texturas/lobo.png");
                break;
            case NO_MUERTO:
                this.health = 250;
                this.damage = 40;
                this.tipo = TipoMonstruos.NO_MUERTO;
                inicializarEtiqueta("/Users/eric/Desktop/Texturas/verde.png");
                break;
            case DEMONIO:
                this.health = 300;
                this.damage = 60;
                this.tipo = TipoMonstruos.DEMONIO;
                inicializarEtiqueta("/Users/eric/Desktop/Texturas/rojo.png");
                break;
            case VAMPIRO:
                this.health = 180;
                this.damage = 70;
                this.tipo = TipoMonstruos.VAMPIRO;
                inicializarEtiqueta("/Users/eric/Desktop/Texturas/vampiro.png");
                break;
            default:
