...
public class Jugador {
    ...
    private final long cooldownEscudo = 10000; // Tiempo de recarga del escudo
    private final long cooldownAtaqueMasivo = 10000; // Tiempo de recarga del ataque masivo
    ...
    public void atacar(List<Monstruo> enemigos) {
        ...
        synchronized (enemigos) {
            ...
            // Cambiar el icono del personaje al sprite de ataque
